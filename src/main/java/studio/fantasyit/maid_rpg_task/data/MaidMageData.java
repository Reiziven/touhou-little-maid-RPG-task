...
public class MaidMageData implements TaskDataKey<MaidMageData.Data> {
    ...
    public static final class Data {
        ...
        public static Data getDefault() { return new Data(0, 0); }

        public int getElementalCooldown() { return elementalCooldown; }
        public void setElementalCooldown(int cooldown) { this.elementalCooldown = cooldown; }
        public int getSpellIndex() { return spellIndex; }
        public void setSpellIndex(int index) { this.spellIndex = index; }
    }

    public static TaskDataKey<Data> KEY = null;
    public static final ResourceLocation LOCATION = ResourceLocation.fromNamespaceAndPath(MaidRpgTask.MODID, "mage");
