...
public class MaidTankTask implements IAttackTask {
    ...
    public List<Pair<Integer, BehaviorControl<? super EntityMaid>>> createBrainTasks(EntityMaid maid) {
        ...
        BehaviorControl<EntityMaid> attackTargetTask = com.github.tartaricacid.touhoulittlemaid.entity.ai.brain.task.MaidMeleeAttack.create(20);
    ...
    @Override
    public boolean isWeapon(EntityMaid maid, ItemStack mainHandItem) {
        return true;
    }
