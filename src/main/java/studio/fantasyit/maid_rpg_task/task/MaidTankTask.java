...
public class MaidTankTask implements IAttackTask {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(MaidRpgTask.MODID, "tank_task");

    @Override
    public ResourceLocation getUid() { return UID; }

    @Override
    public ItemStack getIcon() { return Items.SHIELD.getDefaultInstance(); }
    ...
    public List<Pair<Integer, BehaviorControl<? super EntityMaid>>> createBrainTasks(EntityMaid maid) {
        return Lists.newArrayList(
                ...
                Pair.of(5, StartAttacking.create(this::hasAssaultWeapon, IAttackTask::findFirstValidAttackTarget)),
                Pair.of(5, StopAttackingIfTargetInvalid.create(target -> !hasAssaultWeapon(maid))),
                Pair.of(5, SetWalkTargetFromAttackTargetIfTargetOutOfReach.create(0.6f)),
                Pair.of(5, com.github.tartaricacid.touhoulittlemaid.entity.ai.brain.task.MaidMeleeAttack.create(20)),
                Pair.of(5, new MaidUseShieldTask()),
                Pair.of(3, new TankModifierBehavior()),
                Pair.of(2, new StunBehavior()),
                Pair.of(1, new TankRedirectBehavior())
        );
    }
    ...
    public boolean doExtraAttack(EntityMaid maid, Entity target) {
        ...
        List<EntityExtinguishingAgent> agents = world.getEntitiesOfClass(EntityExtinguishingAgent.class, aabb, Entity::isAlive);
        if (agents.isEmpty()) {
    ...
    private boolean hasAssaultWeapon(EntityMaid maid) { return isWeapon(maid, maid.getMainHandItem()); }

    @Override
    public boolean isWeapon(EntityMaid maid, ItemStack mainHandItem) { return true; }
