...
public class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<SphereShieldEntity>> SPHERE_SHIELD =
            ENTITIES.register("sphere_shield",
                    () -> EntityType.Builder.<SphereShieldEntity>of(SphereShieldEntity::new, MobCategory.MISC)
                            .sized(2.5f, 2.5f).clientTrackingRange(16).build("sphere_shield"));
