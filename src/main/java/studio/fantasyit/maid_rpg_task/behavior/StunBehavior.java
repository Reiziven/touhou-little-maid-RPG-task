...
public class StunBehavior extends Behavior<EntityMaid> {
    ...
    private static final int BALANCED_EXTRA_COOLDOWN = 20;  // +1 second in survival_balanced
    ...
    protected boolean checkExtraStartConditions(ServerLevel level, EntityMaid maid) {
        int cooldown = COOLDOWN_TICKS + (Config.survivalBalanced ? BALANCED_EXTRA_COOLDOWN : 0);
