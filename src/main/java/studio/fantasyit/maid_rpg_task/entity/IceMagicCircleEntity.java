...
public class IceMagicCircleEntity extends Entity implements GeoEntity {
    ...
    private void launchSpike(LivingEntity owner) {
        ...
        AABB searchBox = new AABB(getX() - 24, getY() - 16, getZ() - 24, getX() + 24, getY() + 16, getZ() + 24);
    ...
    public static ResourceLocation getTextureLocation() {
        return ResourceLocation.fromNamespaceAndPath(MaidRpgTask.MODID, "textures/entity/icemcircle.png");
    }
