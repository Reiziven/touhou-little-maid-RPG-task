...
public class EarthSpikeEntity extends Entity implements GeoEntity {
    ...
    public static ResourceLocation getModelLocation() {
        return ResourceLocation.fromNamespaceAndPath(MaidRpgTask.MODID, "geo/earth_spike_spiral.geo.json");
    }

    public static ResourceLocation getTextureLocation() {
        return ResourceLocation.fromNamespaceAndPath(MaidRpgTask.MODID, "textures/entity/spiral_spike.png");
    }

    public static ResourceLocation getAnimationLocation() {
        return ResourceLocation.fromNamespaceAndPath(MaidRpgTask.MODID, "animations/earth_spike.animation.json");
    }
}
